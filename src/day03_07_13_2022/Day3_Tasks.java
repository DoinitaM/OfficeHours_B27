    ...
    /*    Day 3
        ...
        Bedroom
                Kitchen
				            ...
				            ->If the user gives other than these roomTypes, give an error message about
        "Invalid Room Type"
        ...
        Ex:
        inputs:
        Bedroom, length 4, width 3, 1300 Lamar St Houston TX 77010
        ...
        2. Given a string,return the string made of its first two chars, so the String "Hello" yields "He".If the string
        ...
        If the information provided is valid, you will take the first 4 characters of first string and combine them with
        the last three characters of the second string.At the end of your combined string add “@cybertek.com”and print
        the final string as your created email.
